import { useAddDepartmentMutation, useDeleteDepartmentByIdMutation, useGetDepartmentsQuery, useUpdateDepartmentByIdMutation } from '@/redux/slices/Department'
import { validateMessages } from '@/utils/requireMessage'
import { Button, Divider, Form, Input, message, Modal, Select, Spin, Table, Tag } from 'antd'
